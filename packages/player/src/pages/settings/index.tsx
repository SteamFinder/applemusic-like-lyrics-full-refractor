...
export const SettingsPage: FC = () => {
	...
	const [extSpotifyAccessToken, setExtSpotifyAccessToken] = useAtom(extSpotifyAccessTokenAtom);

	// Playing
	const [musicCover, setMusicCover] = useAtom(musicCoverAtom);
	const [musicDuration, setMusicDuration] = useAtom(musicDurationAtom);
	const [musicName, setMusicName] = useAtom(musicNameAtom);
	const [musicPlayingPosition, setMusicPlayingPosition] = useAtom(musicPlayingPositionAtom);
